    ...
    class PostProcessBuildPlayer
    {
        ...
        public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
        {
            if (target == BuildTarget.iOS)
            {
				...
				AddFrameWork(pathToBuiltProject);
				_AddDeviceCapabilities(pathToBuiltProject);
            }
        }

		/// <summary>
		/// Add bitcode permission
		/// </summary>
		/// <param name="path">Porject path.</param>
		...
		/// <summary>
		/// Add info.plist permission
		/// </summary>
		/// <param name="pathToBuiltProject">Porject path.</param>
		static void _AddDeviceCapabilities(string pathToBuiltProject)
		{
			...
			//add description
			rootDict.SetString("NSPhotoLibraryUsageDescription", "iosamap");
		...
		/// </summary>
		/// <param name="pathToBuiltProject">Porject path.</param>
		static void AddFrameWork(string pathToBuiltProject)
		{
			...
			pbxProject.AddFrameworkToProject(targetGUID, "AssetsLibrary.framework", weak: false);

			//build phases
			string file = pbxProject.FindFileGuidByProjectPath("Libraries/Plugins/iOS/advPlugin/WebView.mm");
			List<string> flags = pbxProject.GetCompileFlagsForFile(targetGUID, file);
