...
namespace cqplayart.adv.RWControl
{
	public class RWControlBehavior : MonoBehaviour, controlRW
	{
		...
		/// <param name="name">The gameobject you want to hang the script on.</param>
		/// <param name="callback">The callback.</param>
		public RWControlBehavior Init(string name, controlRWCallback callback)
		{
			GameObject oj = GameObject.Find(name);
			RWControlBehavior initiateBehavior = oj.AddComponent<RWControlBehavior>();
			initiateBehavior.mycallback = callback;

			return initiateBehavior;
		}
